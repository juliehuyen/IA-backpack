...
//        }
        ...
        List<List<Double>> result = new Main3A().getMeanStdDev("selection", "mutation", "onepoint", "weight", ga);
        ...
        List<List<Double>> result2 = new Main3A().getMeanStdDev("selection", "swap", "crossover", "repair", ga);
        ...
        List<List<Double>> result3 = new Main3A().getMeanStdDev("selection", "swap", "multipoints", "weight", ga);
        ...
        List<List<Double>> result4 = new Main3A().getMeanStdDev("tournament", "mutation", "multipoints", "repair", ga);
