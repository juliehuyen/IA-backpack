...
//        }
        ...
        List<List<Double>> result = new Main3C().getMeanStdDev("selection", "mutation", "onepoint", "weight", ga);
        ...
        List<List<Double>> result2 = new Main3C().getMeanStdDev("selection", "swap", "crossover", "repair", ga);
        ...
        List<List<Double>> result3 = new Main3C().getMeanStdDev("selection", "swap", "multipoints", "weight", ga);
        ...
        List<List<Double>> result4 = new Main3C().getMeanStdDev("tournament", "mutation", "multipoints", "repair", ga);
