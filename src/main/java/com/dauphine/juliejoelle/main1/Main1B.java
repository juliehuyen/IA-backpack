...
//        }
        ...
        List<List<Double>> result = new Main1B().getMeanStdDev("selection", "mutation", "onepoint", "weight", ga);
        ...
        List<List<Double>> result2 = new Main1B().getMeanStdDev("selection", "swap", "crossover", "repair", ga);
        ...
        List<List<Double>> result3 = new Main1B().getMeanStdDev("selection", "swap", "multipoints", "weight", ga);
        ...
        List<List<Double>> result4 = new Main1B().getMeanStdDev("tournament", "mutation", "multipoints", "repair", ga);
